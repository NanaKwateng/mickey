...
const CONFIG = {
    ...
    description:
        "Automatically categorize and search through the various technologies, choosing what best fits your idea, or, a detailed explaination of your workflow helps us assist in choosing the best suitable for your brand.",
...
const MagnifiedBento = () => {
    ...
    return (
        <div className="flex items-center justify-center p-4 sm:p-6 w-full not-prose">
            <div className="group relative w-full max-w-[420px] overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] bg-card p-1.5 sm:p-2 transition-all duration-500 hover:shadow-primary/10 hover:-translate-y-1">
                <div
                    ref={containerRef}
                    className={cn(
                ...
                <div className="p-4 sm:p-6 px-4 pb-6 sm:pb-8">
                    <h3 className="text-xl font-medium tracking-tight text-orange-600">
                        {CONFIG.title}
                    </h3>
