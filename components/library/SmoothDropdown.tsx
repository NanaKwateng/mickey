...
// Change Here
const menuItems = [
    { id: "profile", label: "Home", icon: UserIcon, link: "/" },
    { id: "upgrade", label: "About", icon: CreditCardIcon, link: "/about" },
    { id: "projects", label: "Labs", icon: FolderIcon, link: "/labs/dashboard" },
    { id: "documentation", label: "Contact", icon: File01Icon, link: "/contact" },
    { id: "divider", label: "", icon: null, link: "/transition" },
    { id: "settings", label: "Work", icon: SettingsIcon, link: "/strategy" },
    { id: "logout", label: "Jump back", icon: LogoutIcon, link: "/strategy" },
];
                                        ...
                                        >
                                            ...
                                            {showIndicator && (
                                                <motion.div
                                                    ...
                                                    className={`absolute inset-0 rounded-lg ${isLogout ? "bg-red-50" : "bg-muted"
                                                        }`}
                                                    transition={{
                                                        type: "spring",
                                                        damping: 30,
