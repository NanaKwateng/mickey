...
const ITEMS: CollectionItem[] = [
    ...
    },
    {
        ...
        idNumber: "take a look",
        image:
            "/images/design-man.png",
        icon: BrushIcon,
        link: "/transition"
    },
    {
                                    ...
                                    <AnimatePresence mode="popLayout" initial={false}>
                                        {view !== "pack" && (
                                            ...
                                            >
                                                ...
                                                <motion.div
                                                    layout
                                                    className="flex items-center gap-1 px-2 py-1 rounded-full bg-primary/5 text-sm font-bold shrink-0 ml-2 cursor-pointer"
                                                >
