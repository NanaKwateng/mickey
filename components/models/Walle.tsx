...
type WalleProps = JSX.IntrinsicElements["group"]
...
export function Walle(props: WalleProps) {
            ...
            <group name="Object_2">
              <group name="RootNode">
                ...
                <group name="group2" position={[0, 0.024, 0]} rotation={[0, -0.027, 0]}>
                  ...
                  <group name="left_finger2" position={[1.739, -2.203, -0.268]} rotation={[0, 0, 0.015]}>
                    <mesh
                  ...
                  <group name="right_finger3" position={[-1.737, -2.256, 0.189]} rotation={[0, -0.013, 0]}>
                    <mesh
                  ...
                  <group name="left_finger1" position={[1.727, -2.169, -0.591]} rotation={[0, -0.179, 0]}>
                    <mesh
                  ...
                  <group name="right_finger1" position={[-1.628, -2.219, -0.476]} rotation={[0.047, 0, 0]}>
                    <mesh
                  ...
                  <group name="right_arm" position={[-2.224, -0.328, -0.371]} rotation={[0, 0.156, 0]}>
                    <mesh
                  ...
                  <group name="left_arm" position={[2.199, -0.231, -0.475]} rotation={[0, -0.106, 0]}>
                    <mesh
